import {
  to = segment_destination_subscription.id-65add14ba15bde580b9e3219_oLVPAjUzQapjVvPBJgSoFu
  id = "65add14ba15bde580b9e3219:oLVPAjUzQapjVvPBJgSoFu"
}

resource "segment_destination_subscription" "id-65add14ba15bde580b9e3219_oLVPAjUzQapjVvPBJgSoFu" {
