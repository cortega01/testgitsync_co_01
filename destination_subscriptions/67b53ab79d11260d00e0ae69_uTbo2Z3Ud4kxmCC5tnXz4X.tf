import {
  to = segment_destination_subscription.id-67b53ab79d11260d00e0ae69_uTbo2Z3Ud4kxmCC5tnXz4X
  id = "67b53ab79d11260d00e0ae69:uTbo2Z3Ud4kxmCC5tnXz4X"
}

resource "segment_destination_subscription" "id-67b53ab79d11260d00e0ae69_uTbo2Z3Ud4kxmCC5tnXz4X" {
  action_id      = "2P24zUSAL8BUpyGYNGmD7M"
  destination_id = "67b53ab79d11260d00e0ae69"
  enabled        = false
  model_id       = null
  name           = "Identify Calls (Copy) (Copy)"
  settings = jsonencode({
