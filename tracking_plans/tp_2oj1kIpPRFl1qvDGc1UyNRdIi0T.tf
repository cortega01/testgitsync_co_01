...
resource "segment_tracking_plan" "id-tp_2oj1kIpPRFl1qvDGc1UyNRdIi0T" {
  ...
  rules = [
    ...
    {
      json_schema = "{\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"else\":{\"properties\":{\"traits\":{\"minProperties\":0,\"type\":\"object\"}}},\"if\":{\"properties\":{\"eventType\":{\"enum\":[\"Identify\",\"Group\"]}}},\"properties\":{\"context\":{},\"properties\":{},\"traits\":{\"minProperties\":1,\"type\":\"object\"}},\"then\":{\"required\":[\"traits\"]},\"type\":\"object\"}"
      key         = null
      type        = "COMMON"
      version     = 1
    },
