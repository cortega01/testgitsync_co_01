...
resource "segment_tracking_plan" "id-tp_2dyu98FZaICb9fIodsiiGfdR9OM" {
  ...
  rules = [
    ...
    {
      json_schema = "{\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"description\":\"When user clicks on button\",\"properties\":{\"context\":{},\"properties\":{\"properties\":{\"button_type\":{\"description\":\"Type of button\",\"id\":\"/properties/properties/properties/button_type\",\"type\":\"string\"}},\"required\":[\"button_type\"],\"type\":\"object\"},\"traits\":{\"type\":\"object\"}},\"required\":[\"properties\"],\"type\":\"object\"}"
      key         = "Button Clicked"
      type        = "TRACK"
      version     = 1
    },
    {
      json_schema = "{\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"properties\":{\"context\":{},\"properties\":{\"properties\":{\"url\":{\"description\":\"URL of the page\",\"id\":\"/properties/properties/properties/url\",\"type\":\"string\"}},\"type\":\"object\"},\"traits\":{\"type\":\"object\"}},\"type\":\"object\"}"
