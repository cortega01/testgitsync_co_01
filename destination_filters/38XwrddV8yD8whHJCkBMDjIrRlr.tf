import {
  to = segment_destination_filter.id-69322a7307f444425e48ddb1_38XwrddV8yD8whHJCkBMDjIrRlr
  id = "69322a7307f444425e48ddb1:38XwrddV8yD8whHJCkBMDjIrRlr"
}

resource "segment_destination_filter" "id-69322a7307f444425e48ddb1_38XwrddV8yD8whHJCkBMDjIrRlr" {
  actions = [
    {
      fields  = null
      path    = null
