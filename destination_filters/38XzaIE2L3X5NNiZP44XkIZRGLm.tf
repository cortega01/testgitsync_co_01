import {
  to = segment_destination_filter.id-69322a7307f444425e48ddb1_38XzaIE2L3X5NNiZP44XkIZRGLm
  id = "69322a7307f444425e48ddb1:38XzaIE2L3X5NNiZP44XkIZRGLm"
}

resource "segment_destination_filter" "id-69322a7307f444425e48ddb1_38XzaIE2L3X5NNiZP44XkIZRGLm" {
  actions = [
    {
      fields  = null
      path    = null
