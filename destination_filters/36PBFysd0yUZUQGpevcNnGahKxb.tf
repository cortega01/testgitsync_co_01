import {
  to = segment_destination_filter.id-69322a7307f444425e48ddb1_36PBFysd0yUZUQGpevcNnGahKxb
  id = "69322a7307f444425e48ddb1:36PBFysd0yUZUQGpevcNnGahKxb"
}

resource "segment_destination_filter" "id-69322a7307f444425e48ddb1_36PBFysd0yUZUQGpevcNnGahKxb" {
  actions = [
    {
      fields  = null
      path    = null
